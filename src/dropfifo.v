...
// /___/   /\     Timestamp : 01/28/2026 15:46:07
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w C:/lab3/ise/dropfifo.sch dropfifo.vf
...
module dropfifo(clk, 
   ...
   dual9bmem2 XLXI_2 (.addra(waddr[7:0]), 
                      .addrb(raddr[7:0]), 
                      .clka(clk), 
                      .clkb(clk), 
                      .dina(in_fifo0[71:0]), 
   ...
   CB8CE_MXILINX_dropfifo XLXI_14 (.C(clk), 
                                   .CE(XLXN_34), 
                                   .CLR(rst), 
                                   .CEO(), 
                                   .Q(raddr[7:0]), 
                                   .TC());
   // synthesis attribute HU_SET of XLXI_14 is "XLXI_14_19"
   reg9b XLXI_15 (.ce(XLXN_35), 
                  .clk(clk), 
                  .clr(rst), 
                  .d(in_fifo[71:0]), 
                  .q(in_fifo0[71:0]));
   AND3B2 XLXI_16 (.I0(XLXN_27), 
                   .I1(XLXN_26), 
                   .I2(fiforead), 
                   .O(XLXN_34));
   VCC XLXI_17 (.P(XLXN_35));
endmodule
